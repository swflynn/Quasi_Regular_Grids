!=================20==================40==================60==================80
!                     Pseudo-Random Grid Generation Main                       !
!==============================================================================!
!Pseudo-Random Grid for a d-dimensional system using a cutoff or rejection.
...
call P_Rand(potential,reject,Npoints,d,x,V_i,E_cut,xmin,xmax,integral_P)
call write_out(potential,reject,Npoints,d,E_cut,xmin,xmax,N_1D,N_MMC_box,&
  integral_P)
end program prand_grid
