!=================20==================40==================60==================80
!                    Quasi-Random Grid Generation Module                      !
!==============================================================================!
!Generate a d-dimensional quasi_random grid using a cutoff contour or rejection
...
!==============================================================================!
subroutine Q_Rand(potential,reject,Npoints,d,x,V_i,E_cut,xmin,xmax,integral_P)
!==============================================================================!
...
!==============================================================================!
subroutine write_out(potential,reject,Npoints,d,E_cut,xmin,xmax,N_1D,&
