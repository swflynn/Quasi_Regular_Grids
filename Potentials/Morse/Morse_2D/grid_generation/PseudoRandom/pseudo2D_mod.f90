...
!The rejection method or a cutoff is applied to a Pseudo-random sequence
!==============================================================================!
!       Modified:
!   25 Feburary 2020
!       Author:
